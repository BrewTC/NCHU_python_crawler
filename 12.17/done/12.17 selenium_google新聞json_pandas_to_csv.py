...
#將資料轉存為json格式
with open('google頭條新聞.json', 'wt', encoding='UTF-8') as file:
    file.write(article_json)

#使用pandas將json格式轉存成csv
# df = pd.read_json('google新聞.json')
# export_csv = df.to_csv('google新聞.csv', index = None, header = True)
